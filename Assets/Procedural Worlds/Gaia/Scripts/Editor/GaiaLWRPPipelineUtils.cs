...
namespace Gaia.Pipeline.LWRP
{
    ...
    public static class GaiaLWRPPipelineUtils
    {
        ...
        private static void ConfigureCamera()
        {
            ...
            {
#if LWPipeline
                UnityEngine.Rendering.Universal.UniversalAdditionalCameraData cameraData = camera.gameObject.GetComponent<UnityEngine.Rendering.Universal.UniversalAdditionalCameraData>();
                if (cameraData == null)
                {
        ...
        {
#if LWPipeline
            UnityEngine.Rendering.Universal.UniversalAdditionalLightData[] lightsData = Object.FindObjectsOfType<UnityEngine.Rendering.Universal.UniversalAdditionalLightData>();
            if (lightsData != null)
            {
                foreach (UnityEngine.Rendering.Universal.UniversalAdditionalLightData data in lightsData)
                {
                    if (data.gameObject.GetComponent<UnityEngine.Rendering.Universal.UniversalAdditionalLightData>() == null)
                    {
                        data.gameObject.AddComponent<UnityEngine.Rendering.Universal.UniversalAdditionalLightData>();
                    }
                }
            }
#endif
        ...
        {
#if LWPipeline
            UnityEngine.Rendering.Universal.UniversalAdditionalCameraData[] camerasData = Object.FindObjectsOfType<UnityEngine.Rendering.Universal.UniversalAdditionalCameraData>();
            if (camerasData != null)
            {
                foreach (UnityEngine.Rendering.Universal.UniversalAdditionalCameraData data in camerasData)
                {
